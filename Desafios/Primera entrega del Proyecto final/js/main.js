...
function bienvenida(){    
    ...
    catalogo.forEach((maqueta)=>{alert(maqueta.nombre + ' ' + maqueta.marca + ' escala en ' + maqueta.escala + ' ' + maqueta.precio + ' pesos.')});
}
...
//Agregar al carrito pidiendo el nombre del producto:
...
function filtrar(filtro){
    const busqueda = catalogo.filter((maqueta) => maqueta.precio < filtro)
